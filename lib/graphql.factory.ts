...
export class GraphQLFactory {
  private autoGeneratedSchema: GraphQLSchema
  ...
  async mergeOptions(
    ...
    if (options.autoSchemaFile) {
      this.autoGeneratedSchema = this.autoGeneratedSchema || await this.gqlSchemaBuilder.build(
      ...
      const executableSchema = makeExecutableSchema({
        ...
        typeDefs: gql`
          ${printSchema(this.autoGeneratedSchema)}
        `,
      ...
      const autoGeneratedSchemaConfig = this.autoGeneratedSchema.toConfig();
